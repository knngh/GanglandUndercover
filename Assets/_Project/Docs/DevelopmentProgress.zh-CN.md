...
6. 会议面板：圆桌席位板、证据墙、文本频道块、投票倒计时、玩家席位。
...
1. Vivox 已移除，文本聊天替代；语音功能不再纳入当前版本。
...
7. 新增会议专用场景：圆桌、聊天席位、证据墙、投票卡、头顶遮挡和阵营色证据线。
8. 新增断电专用场景：电房断电墙、红色应急灯、修复 pad、可读线缆、熔断槽和应急路线箭头。
9. 新增 Stage1 可编辑锚点目录：开局、行动、断电、会议、结算、房间入口、任务、击倒视线、报案路线、聊天范围锚点、暗线口。
...
4. Vivox 已移除（文本聊天替代），Lobby/Relay 外网测试仍在第 5 阶段。
...
1. 每个在线玩家/AI 生成 `Stage2 Character` 状态层，覆盖交互半径、近距离聊天范围锚点、朝向楔形、手持交互道具和脚步提示。
...
6. 烟测新增 Stage2 门槛：角色状态层、行动聊天范围锚点、击倒状态、报案现场、会议入座和投票反馈缺失都会失败。
